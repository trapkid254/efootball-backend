...
// @desc    Initiate payment for tournament entry
// @access  Private
router.post('/initiate', auth, async (req, res) => {
    try {
        ...
        // Format phone number for MPesa (2547...)
...
// @route   POST /api/payments/prize/payout
// @desc    Initiate prize payout (Admin only)
// @access  Private (Admin)
router.post('/prize/payout', adminAuth, async (req, res) => {
    try {
        ...
        // In a real implementation, you would use B2C API for payouts
